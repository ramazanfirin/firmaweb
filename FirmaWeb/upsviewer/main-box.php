<!-- main-box begin-->
						<div class="main-box"   style="background-image:url('images/upsroom.jpg');background-color:#000001;" >
							<div class="inner">   
							 	<img alt="" src="images/slogan_3.jpg" />
									<ul>
										<li><a href="#">Bütün Güç cihazlarla çalışabilme</a></li>
										 <li><a href="#">Bütün UPS markaları işe çalışabilme</a></li>
										 <li><a href="#">Bütün protokoller ile çalışabilme</a></li>
										 <li><a href="#">UPS e ait bütün verileri görebilme</a></li>
										 <li><a href="#">UPS dataları kaydetme ve rapor alabilme</a></li>
										 <li><a href="#">Sınırsız Alarm Tanımlayabilme</a></li>
										 <!--  <li><a href="#">Yetki bazlı kullanıcı tanımlayabilme</a></li>-->
